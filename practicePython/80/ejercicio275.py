...
class Aplicacion:
    ...
    def agregar_menu(self):
        ...
        opciones1.add_command(label="Guardar arcivo",command=self.guardar)
    ...
    def recuperar(self):
        nombrearch=fd.askopenfilename(initialdir="/", title="Seleccione archivo", filetype=(("txt files", "*.txt"), ("todos los archivos", "*.*")))
