...
class Aplicacion:
    ...
    def grafico_tarta(self):
        ...
        self.canvas1.create_text(500, 50, text="partido A:"+str(valor2), fill="blue", font="Arial")
        self.canvas1.create_text(500, 50, text="partido A:"+str(valor3), fill="yellow", font="Arial")
